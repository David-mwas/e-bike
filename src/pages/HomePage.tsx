        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-20">
          <div className="max-w-lg">
            ...
            <p className="text-lg mb-8">
              Explore our premium selection of e-bikes designed for every
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 mb-6">
                "My Alpine Explorer Pro has transformed my mountain biking
                experience. The motor assistance is smooth and natural, and the
                battery life is exceptional. Worth every penny!"
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 mb-6">
                "I commute 15 miles daily on my Urban Commuter Elite, and it's
                been a game-changer. No more traffic jams or parking hassles,
                and I arrive at work without breaking a sweat."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-gray-300 mr-4"></div>
                <div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 mb-6">
                "The Compact Folder X3 is perfect for my city apartment. It
                folds easily, is lightweight enough to carry up stairs, and the
                battery life is impressive for such a compact bike."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-gray-300 mr-4"></div>
                <div>
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            ...
            commutes, adventures, and fitness journeys with our premium electric
            bikes.
          </p>
          <Link
            to="/shop"
